...
<script setup lang="ts">
  ...
  const people = [
    {
      quote:
        'ACM NIT Surat has been an incredible platform for sharpening my problem-solving skills. The coding competitions and workshops shaped me into a better engineer.',
      author: 'Keshav Gautam',
      position: 'Chairperson 2021 — ACM NIT Surat',
      tags: ['Leadership', 'Competitive Programming', 'Community'],
      profile: undefined,
    },
    {
      quote:
        'Being part of the ACM chapter gave me exposure to real-world software development. The developer team taught me collaboration, version control, and building things that matter.',
      author: 'Garvit Shah',
      position: 'Chairperson 2023 — ACM NIT Surat',
      tags: ['Web Development', 'Open Source', 'Teamwork'],
      profile: undefined,
    },
  ];
</script>
