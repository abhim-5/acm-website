...
export default function EventTicker() {
  ...
  useEffect(() => {
    ...
    createMarquee(marquee1Ref.current, 1, 50);
    createMarquee(marquee2Ref.current, -1, 50);
    ...
    return () => {
      ...
      gsap.killTweensOf(marquee1Ref.current);
      gsap.killTweensOf(marquee2Ref.current);
    };
  }, []);
